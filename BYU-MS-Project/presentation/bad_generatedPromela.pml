...
proctype process_Process_2(byte cwpArrayIndex; chan reportChannel; msgType message){
	byte token_EndEvent_8_22, token_ExclusiveGateway_1_16, token_ExclusiveGateway_2_13, token_ExclusiveGateway_5_18, token_ExclusiveGateway_5_19, token_ParallelGateway_3_20, token_ParallelGateway_3_21, token_ScriptTask_1_12, token_ScriptTask_3_14, token_UserTask_4_17, token_UserTask_5_15;
	msgType orderStatus;
	...
	do
		...
		::xor_join(983/*ExclusiveGateway_5: xor join*/, token_ExclusiveGateway_5_18, token_ExclusiveGateway_5_19, token_ParallelGateway_3_21)
		::parallel_join(982/*parallel_join*/, token_ParallelGateway_3_20, token_ParallelGateway_3_21, token_EndEvent_8_22)
		::in_tokens(token_ScriptTask_1_12) -> 
			atomic{
			print(981/*orderStatus-ScriptTask_1*/);
			   orderStatus.msg = outOfStock
			out_tokens(token_ParallelGateway_3_20)
			}
	...
	atomic{
	if
		::(token_EndEvent_8_22 == 0 && token_ExclusiveGateway_1_16 == 0 && token_ExclusiveGateway_2_13 == 0 && token_ExclusiveGateway_5_18 == 0 && token_ExclusiveGateway_5_19 == 0 && token_ParallelGateway_3_20 == 0 && token_ParallelGateway_3_21 == 0 && token_ScriptTask_1_12 == 0 && token_ScriptTask_3_14 == 0 && token_UserTask_4_17 == 0 && token_UserTask_5_15 == 0 )->
			reportChannel!normal
		::else->
			...
			printf("token_ParallelGateway_3_20 %d\n", token_ParallelGateway_3_20);
			printf("token_ParallelGateway_3_21 %d\n", token_ParallelGateway_3_21);
